...
#X_new = Coordinate(10,20)
#print(x_new.__eq__(X_new))
#print(x_new.__repr__())         

# Your task is to define the following '<' + str(self.getX()) + ',' + str(self.getY()) + '>'two methods for the Coordinate class:
...
def main():
    ...
    print(Coordinate(data[0],data[1]).__repr__())
